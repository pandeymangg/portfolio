      ...
      <div className="flex flex-col mb-10">
        <div className="mt-4">
          ...
          <ul className="list-disc ml-6 mt-2 text-textPrimary">
            ...
            <li>
              Implemented bulletproof validation for the survey builder,
              ensuring that no surveys are created with invalid configurations.
            </li>
            <li>
            ...
            <li>
              Implemented the entire storage system for Formbricks, ensuring
              users and admins can easily upload files and take files in
              responses.
            </li>
          </ul>
        </div>
        ...
        <div className="mt-6">
          ...
          <ul className="list-disc ml-6 mt-2 text-textPrimary">
            <li>
              Implemented type checking on the front-end using TypeScript.
            </li>
            <li>
            ...
            <li>
              Worked on Tealfeed’s Creator Program, implemented the front-end
        ...
        <div className="mt-6">
          ...
          <ul className="list-disc ml-6 mt-2 text-textPrimary">
            ...
            <li>
              Used redux-toolkit for state management and data fetching
