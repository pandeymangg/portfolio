...
const Home = () => {
  return (
    <section id="home" className="home pt-20 px-8">
      <div className="max-w-2xl md:mx-auto">
        ...
        <div className="home-intro">
          <p className="text-gray-600 dark:text-gray-100 text-base mb-4">
            I'm a{" "}
          ...
          <p className="text-gray-600 dark:text-gray-100 text-base mb-8">
            I have worked with{" "}
          ...
          <div className="home-intro-links">
            <div className="mb-4">
              <p className="font-semibold text-gray-600 dark:text-gray-100 text-lg">
                Connect with me:{" "}
              </p>
            </div>
